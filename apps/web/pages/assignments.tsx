...
import { AssignmentBlock } from '@heggenplanen/typings'
...
import { TypePrimaryBox, TypeDisabledBox } from '@heggenplanen/components/style'
	...
	return (
		<div>
			<Typography variant='h4'>
				<TypePrimaryBox>{label}</TypePrimaryBox>
			</Typography>
			<br />
